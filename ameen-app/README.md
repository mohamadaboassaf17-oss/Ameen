...
<p align="center">
  <img src="https://img.shields.io/github/license/Ameen-PW/ameen?color=blue" alt="License: AGPLv3" />
  ...
  <img src="https://img.shields.io/github/v/release/Ameen-PW/ameen?include_prereleases" alt="GitHub release" />
</p>
...
cd shared-crypto
npm ci
npm run build          # Outputs to shared-crypto/dist/
```
...
```bash
cd android
./gradlew assembleDebug    # Debug APK at android/app/build/outputs/apk/debug/
```
...
```bash
dotnet build windows/Ameen.Windows.sln
```
...
Ameen is licensed under the **GNU Affero General Public License v3.0 (AGPLv3)**. See [LICENSE](./LICENSE) for the full text.
